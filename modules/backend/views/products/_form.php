...
<div class="content-form">
    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($model, 'category_id',['options'=>['style'=>'display:none']])->widget(Select2::className(),['data'=>(new \app\helpers\CategoryHelper(['categories'=>$model->categories]))->getKV()]) ?>
        </div>
        <div class="col-sm-12">
