        ...
        <div class="col-md-12 column">
            <div class="shows" >
                ...
                <dl class="show_left">
                    ...
                    <dd><span>组织/细胞部位:</span><?=$model->postion?></dd>
                    <dd><span>样本处理方式:</span><?=$model->handle?></dd>
                    <dd><span>标本存放位置:</span><?=$model->place?></dd>
                    ...
                    <div class="col-md-12 column" style="padding-left: 0;padding-top: 0;margin-bottom: 30px;">
                        <ul class="list-unstyled list-inline">
                            ...
                            <?php  foreach($child as $child): ?>
                                <li style="font-family: '微软雅黑';float: left">
                                    <?= Html::a("$child[section_name]", ['sdyeing','at'=>1, 'id' => $child['id']], ['title'=>'查看']) ?>
