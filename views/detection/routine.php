        ...
        <div class="col-md-12 column">
            <div class=" shows" style="padding-top: 5px;padding-bottom: 0;width: 100%">
                ...
                <dl class="show_left">
                    ...
                    <dd><span>检测流程:</span><?=$model->process?></dd>
                    <dd><span>检测原理	:</span><?=$model->axiom?></dd>
                </dl>
                    ...
                    <div class="col-md-12 column" style="padding-left: 0;padding-top: 0;margin-bottom: 30px;">
                        <ul class="list-unstyled list-inline">
                            ...
                            <?php  foreach($child as $child): ?>
                                <li style="font-family: '微软雅黑';float: left">
                                    <?= Html::a("$child[name]", ['reagent','at'=>2, 'id' => $child['id']], ['title'=>'查看']) ?>
            ...
            <?= Html::a('下载指标', ['exportroutine', 'id' => $model['id'],'at'=>1], ['class' => 'btn btn-success btn-large','title'=>'查看']) ?>
